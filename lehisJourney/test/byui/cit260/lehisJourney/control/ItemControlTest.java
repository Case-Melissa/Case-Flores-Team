...
public class ItemControlTest {
    ...
    public void testCalcBasketVolume() {
         ...
         *********
         */
        ErrorView.display(this.getClass().getName(), "calcBasketVolume");
        double height = 32.0;
        double width = 15.0;
        double length = 30.0;
    ...
    public void testCalcLabansChallenge() {
         ErrorView.display(this.getClass().getName(),"calcLabansChallenge");
        /**
         * ********
         * Case Test #1
         *********
    ...
    public void testCalcAreaTentRoom() {
         ...
         *********
         */
         ErrorView.display(this.getClass().getName(),"calcAreaTentRoom");
        double length = 16.0;
        double width = 16.0;
        double height = 8.0;
        int peopleInRoom = 2;
